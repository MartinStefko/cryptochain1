...
describe('Blockchain', () => {
    ...
    describe('validTransactionData()', () => {
        ...
        describe('and the transaction data has at leats one malformed outputMap', () => {
            describe('and the transation is not a reward transaction', () => {
                it('returns false and logs an error', () => {
            ...
            describe('and the transation is a reward transaction', () => {
                it('returns false and logs an error', () => {
